<?php
/**
 * Plugin Name: Merchium Shopping Cart
 * Plugin URI:  http://merchium.com
 * Description: Merchium
 * Author:      Simtech Ltd.
 * Author URI:  http://merchium.com
 * Version:     1.0.4
 */
...
define('MERCHIUM_SITE_URL', 'http://www.merchium.com/');
define('MERCHIUM_SITE_API_URL', MERCHIUM_SITE_URL . 'wp-json.php/');

define('MERCHIUM_VOTE_URL', 'http://wordpress.org/support/view/plugin-reviews/merchium');
define('MERCHIUM_SHOW_VOTE_MESSAGE_AFTER', 30 * 24 * 60 * 60); // 30 days

define('MERCHIUM_VERSION_IDENTIFY', 'Merchium');
